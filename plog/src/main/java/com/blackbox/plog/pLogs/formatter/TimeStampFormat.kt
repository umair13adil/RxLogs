...
object TimeStampFormat {
    ...
    val TIME_FORMAT_FULL_JOINED = "ddMMyyyy_kkmmss_a"
    val TIME_FORMAT_FULL_1 = "dd MMMM yyyy kk:mm:ss"
    val TIME_FORMAT_FULL_2 = "MM:dd:yyyy hh:mm:ss a"
    val TIME_FORMAT_24_FULL = "dd/MM/yyyy kk:mm:ss"
    val TIME_FORMAT_READABLE = "dd MMMM yyyy hh:mm:ss a"
    val TIME_FORMAT_SIMPLE = "kk:mm:ss"
}